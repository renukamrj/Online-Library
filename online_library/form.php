...
<head>
  ...
  <link href="https://fonts.googleapis.com/css?family=Lato:300,300i" ref="stylsheet">
</head>
<body>
  <div id="topLine"></div>
  <div id="mainContent">
      ...
      <form action="form-action.php" method="post" name="signup" id="signup">
        ...
        <p>
          ...
          <select name="howotentrack" id="howoftentrack">
            <option value="daily">Book</option>
        ...
        <p>
          ...
          <p>
          <input class="buttom lgButton" type="submit" name="submit" id="submit" value="submit">
          </p>
      </form>
    </div>
  </body>
